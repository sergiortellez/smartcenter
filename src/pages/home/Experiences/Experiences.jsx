    ...
    return (
        <section id="experiences">
            ...
            <div className={styles.experiencesGrid} >
                <ExpandableCard
                    buttonContent={<div> button content 1</div>}
                ...
                <ExpandableCard
                    buttonContent={<div> button content 2</div>}
                    expandedContent={<div>Contenido Expandido Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae repellat, facere nam pariatur earum a obcaecati, optio facilis illum, blanditiis quo aspernatur totam veniam. Vel eos, nostrum ipsum optio voluptatibus officiis eius consectetur rem dolorum maiores? Exercitationem, aliquam. Temporibus, cum.</div>}
                    areaName='second'
                />

                <ExpandableCard
                    buttonContent={<div> button content 3</div>}
                    expandedContent={<div>Contenido Expandido Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae repellat, facere nam pariatur earum a obcaecati, optio facilis illum, blanditiis quo aspernatur totam veniam. Vel eos, nostrum ipsum optio voluptatibus officiis eius consectetur rem dolorum maiores? Exercitationem, aliquam. Temporibus, cum.</div>}
                    areaName='third'
                />
                <ExpandableCard
                ...
                />
                <ExpandableCard
                    buttonContent={<div> button content 5</div>}
                    expandedContent={<div>Contenido Expandido Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae repellat</div>}
                    areaName='fifth'
                />
            </div>
        </section>
